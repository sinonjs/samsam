...
describe("deepEqual", function() {
    ...
    it("return false when comparing two similar matchers to each other", function() {
    ...
    it("returns true if comparing the same instance of a matcher to it's self", function() {
        var matcher1 = createMatcher.has("foo");
